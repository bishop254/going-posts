...
func (a *application) forbiddenError(w http.ResponseWriter, r *http.Request, err error) {
	a.logger.Errorw("forbidden error", "method", r.Method, "path", r.URL.Path, "err", err.Error())
